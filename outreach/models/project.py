...
class wizard(models.TransientModel):
    ...
    point = fields.Selection([('Pharmacy', 'SAN-KER Pharmacy'), ('Outreach', 'Outreach'), ('Mawkyrwat', 'Mawkyrwat Project'), ('Nongstoin','Nongstoin Project'), ('Mairang','Mairang Project'),('Fatima','Fatima Project')], string='Location', default='Pharmacy')
